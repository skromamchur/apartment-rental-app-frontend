...
import FlatImage from '../../public/flat.png';
...
const StairsIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
    <g clip-path="url(#clip0_1012_1861)">
      <path d="M14.2377 2.95724H11.4975C11.0765 2.95724 10.7353 3.29818 10.7353 3.71932V5.69763H8.75705C8.33591 5.69763 7.99472 6.03845 7.99472 6.45962V8.43806H6.01641C5.59527 8.43806 5.2542 8.77937 5.2542 9.20008V11.2738H3.18094C2.97864 11.2738 2.78478 11.354 2.6419 11.4968C2.4989 11.6396 2.4187 11.8343 2.4187 12.0358L2.41895 13.6303C2.41895 14.0518 2.76026 14.3927 3.18116 14.3927H14.2377C14.6589 14.3927 14.9999 14.0518 14.9999 13.6303V3.71929C15 3.29818 14.6589 2.95724 14.2377 2.95724Z" fill="black"/>
      <path d="M10.2266 0.76076C10.0304 0.559664 9.70912 0.555799 9.50814 0.751453C6.24859 3.92669 3.14766 7.028 0.148905 10.0265C0.0534895 10.1219 0 10.2515 0 10.386V13.8635C0 14.1437 0.227408 14.3717 0.508119 14.3717C0.788553 14.3717 1.01636 14.1438 1.01636 13.8635V10.5963C3.96645 7.64609 7.01643 4.59769 10.2171 1.47925C10.418 1.28363 10.4221 0.961732 10.2266 0.76076Z" fill="black"/>
    </g>
    <defs>
...
export const FlatCard = ({ photo, price, city, street, roomsCount, square, floorNumber, title }) => (
  <div
  ...
  >
    ...
    <div className="mt-3 text-sm text-black">{title}</div>
    <div className="mt-3 text-xs text-black text-opacity-50">{city}, {street}</div>
    <div className="mt-3 text-xs text-black text-opacity-50">20 November 2020</div>
    <div className="mt-3 space-x-2 flex flex-row">
      <div className="space-x-2 flex flex-row items-end">
        <RoomIcon />
        <span className="text-xs text-black -mt-2">{roomsCount}+1</span>
      </div>
      <div className="space-x-2 flex flex-row items-end">
        <StairsIcon />
